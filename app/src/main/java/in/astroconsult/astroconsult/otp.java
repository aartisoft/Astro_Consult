...
public class otp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pinEntry = (PinEntryEditText) findViewById(R.id.txt_pin_entry_next);
        progressBar = findViewById(R.id.progress_bar_next);
        verify = findViewById(R.id.otpButtonNext);
        resendOtp = findViewById(R.id.resendOtpNext);

        phone = getIntent().getStringExtra("mobileNext");
        /*if (pinEntry != null) {
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(otp.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            LogInPreference.getInstance(otp.this).setLogged(true);
